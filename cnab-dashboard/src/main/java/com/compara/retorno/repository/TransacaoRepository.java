...
public interface TransacaoRepository extends JpaRepository<Transacao, Long> {
    ...
    List<Transacao> findMatch(TipoOrigem tipoOrigem, String nossoNumero, BigDecimal valorPago, java.time.LocalDate dataOcorrencia);
    ...
    Page<Transacao> findByTipoOrigemAndDataOcorrenciaBetween(TipoOrigem tipoOrigem, java.time.LocalDate startDate, java.time.LocalDate endDate, Pageable pageable);
    ...
    Page<Transacao> findByTipoOrigemAndDataCreditoBetween(TipoOrigem tipoOrigem, java.time.LocalDate startDate, java.time.LocalDate endDate, Pageable pageable);
